...
[lq| ins :: (Ord a) => a -> t:RBT a -> {v: ARBT a | ((IsB t) => (isRB v))} |]
...
[lq| del              :: (Ord a) => a -> t:RBT a -> {v:ARBT a | ((isB t) || (isRB v))} |]
del x Leaf           = Leaf
...
[lq| append :: y:a -> l:RBT a -> r:RBT a -> (ARBT2 a l r) |]
...
[lq| deleteMin' :: k:a -> l:RBT a -> r:RBT a -> (a, ARBT2 a l r) |]
...
[lq| lbalS                             :: k:a -> l:ARBT a -> r:RBT a -> {v: ARBT a | ((IsB r) => (isRB v))} |]
...
[lq| rbalS                             :: k:a -> l:RBT a -> r:ARBT a -> {v: ARBT a | ((IsB l) => (isRB v))} |]
...
[lq| lbal                              :: k:a -> l:ARBT a -> RBT a -> RBT a |]
...
[lq| rbal                              :: k:a -> l:RBT a -> ARBT a -> RBT a  |]
...
[lq| type BlackRBT a = {v: RBT a | (IsB v)} |]

[lq| makeRed :: l:BlackRBT a -> ARBT a |]
...
[lq| type RBT a    = {v: RBTree a | (isRB v)} |]
...
[lq| type ARBT a    = {v: RBTree a | (isARB v) } |]
...
[lq| type ARBT2 a L R = {v:ARBT a | (((IsB L) && (IsB R)) => (isRB v))} |]
...
[lq| predicate Invs V = ((Inv1 V) && (Inv2 V))               |]
