...
[lq| data Point = P { px :: Double, py :: Double } |]

-- | When are two points "equal" ?

[lq| predicate EqPoint P1 P2 = (px P1 == px P2 && py P1 == py P2) |]
                
-- | Squaring numbers: DYNAMIC checks establish numerical properties

[lq| square :: x:Double -> PosZ x |]
