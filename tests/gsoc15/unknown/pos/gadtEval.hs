...
[lq| check          :: e:ValidExpr  -> {v:Ty | (v = (eType e))} |]
check (I _)        = TInt
check (B _)        = TBool
...
[lq| eval           :: e:ValidExpr  -> {v:ValidExpr | ((isValue v) && (((eType e) = (eType v))))} |]
eval e@(I _)       = e
eval e@(B _)       = e
...
[lq| toInt :: IntExpr -> Int |]
toInt (I i) = i
toInt _     = liquidError "impossible"

[lq| toBool :: BoolExpr -> Bool |]
toBool (B b) = b
toBool _     = liquidError "impossible"


[lq| predicate TInt X   = ((eType X) = TInt)  |]
[lq| predicate TBool X  = ((eType X) = TBool) |]


[lq| type ValidExpr     = {v: Expr | (isValid v)}                |]
[lq| type IntExpr       = {v: Expr | ((isValue v) && (TInt  v))} |]
[lq| type BoolExpr      = {v: Expr | ((isValue v) && (TBool v))} |]
