...
[lq| predicate Elem  X Ys       = Set_mem X Ys               |]
...
----------------------------------------------------------------------------
[lq| alpha :: ys:(S.Set Bndr) -> e:{Expr | isAbs e} -> {v:Expr | EqV v e} |]
----------------------------------------------------------------------------
...
----------------------------------------------------------------------------
[lq| freshS :: xs:(S.Set Bndr) -> {v:Bndr | NotElem v xs} |]
----------------------------------------------------------------------------
freshS xs = undefined
...
----------------------------------------------------------------------------
[lq| free         :: e:Expr -> {v : S.Set Bndr | v = fv e} |]
----------------------------------------------------------------------------
