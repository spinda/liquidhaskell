...
[lq| append :: y:a -> l:RBT a -> r:RBTN a {(bh l)} -> (ARBT2 a l r) |]
...
[lq| deleteMin'                   :: k:a -> l:RBT a -> r:RBTN a {(bh l)} -> (a, ARBT2 a l r) |]
...
[lq| lbalS  :: k:a -> l:ARBT a -> r:RBTN a {1 + (bh l)} -> {v: ARBTN a {1 + (bh l)} | ((IsB r) => (isRB v))} |]
...
[lq| rbalS  :: k:a -> l:RBT a -> r:ARBTN a {(bh l) - 1} -> {v: ARBTN a {(bh l)} | ((IsB l) => (isRB v))} |]
...
[lq| lbal  :: k:a -> l:ARBT a -> RBTN a {(bh l)} -> RBTN a {1 + (bh l)} |]
...
[lq| rbal  :: k:a -> l:RBT a -> ARBTN a {(bh l)} -> RBTN a {1 + (bh l)} |]
...
[lq| type RBT a    = {v: RBTree a | ((isRB v) && (isBH v)) } |]
...
[lq| type ARBT a    = {v: RBTree a | ((isARB v) && (isBH v))} |]
