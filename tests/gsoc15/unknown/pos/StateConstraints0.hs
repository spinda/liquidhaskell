...
[lq| incr :: ST <{\x -> true}, {\x v -> v = x + 1}, {\x v -> v = x}>  Int Int |]
incr :: ST Int Int
incr = ST $ \x ->  (x, x + 1)

[lq| foo :: ST <{\x -> true}, {\x v -> true}, {\x v -> v = 0}>  Bool Int |]
foo :: ST Bool Int
foo = return 0

[lq| incr2 :: ST <{\x -> true}, {\x v -> v = x + 2}, {\x v -> v = x + 1}>  Int Int |]
incr2 :: ST Int Int
incr2 = incr >> incr

[lq| incr3 :: ST <{\x -> true}, {\x v -> v = x + 3}, {\x v -> v = x + 2}>  Int Int |]
incr3 :: ST Int Int
incr3 
  = incr >> incr >> incr

run :: (Int, Int)
[lq| run :: ({v:Int |  v = 1}, {v:Int |  v = 2}) |]
