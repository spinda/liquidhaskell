...
[lq| ins :: (Ord a) => a -> t:RBT a -> RBTN a {(bh t)}  |]
...
[lq| del              :: (Ord a) => a -> t:RBT a -> {v:RBT a | (HDel t v)} |]
del x Leaf           = Leaf
...
[lq| append :: y:a -> l:RBT a -> r:RBTN a {(bh l)} -> RBTN a {(bh l)} |]
...
[lq| deleteMin'                   :: k:a -> l:RBT a -> r:RBTN a {(bh l)} -> (a, RBTN a {(bh l)}) |]
...
[lq| lbalS  :: k:a -> l:RBT a -> r:RBTN a {1 + (bh l)} -> RBTN a {1 + (bh l)} |]
...
[lq| rbalS  :: k:a -> l:RBT a -> r:RBTN a {(bh l) - 1} -> RBTN a {(bh l)}    |]
...
[lq| lbal  :: k:a -> l:RBT a -> RBTN a {(bh l)} -> RBTN a {1 + (bh l)} |]
...
[lq| rbal  :: k:a -> l:RBT a -> RBTN a {(bh l)} -> RBTN a {1 + (bh l)} |]
...
[lq| makeRed :: l:RBT a -> RBTN a {(bh l) - 1} |]
makeRed (Node B x l r) = Node R x l r
makeRed _              = error "nein"

[lq| makeBlack :: RBT a -> RBT a |]
makeBlack Leaf           = Leaf
...
[lq| type RBT a    = {v: RBTree a | (isBH v) }   |]
